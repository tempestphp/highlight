...
class TwigLanguageTest extends TestCase
{
    ...
    public static function data(): array
    {
        return [
            ...
            ['{#<div class="form-inline">#}', '<span class="hl-injection"><span class="hl-comment">{#&lt;div class=&quot;form-inline&quot;&gt;#}</span></span>'],
            ['{#<a href="#">{{ app.user.userIdentifier }}</a>#}', '<span class="hl-injection"><span class="hl-comment">{#&lt;a href=&quot;#&quot;&gt;{{ app.<span class="hl-property">user</span>.<span class="hl-property">userIdentifier</span> }}&lt;/a&gt;#}</span></span>'],
            ...
            ['{% cache "cache key" %}', '{% <span class="hl-keyword">cache</span> &quot;<span class="hl-value">cache key</span>&quot; %}'],
        ];
    }
}
