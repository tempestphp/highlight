...
use Tempest\Highlight\Languages\Antlers\Injections\AntlersSubExpressionInjection;
...
use Tempest\Highlight\Languages\Antlers\Patterns\NestedVariablePattern;
...
use Tempest\Highlight\Languages\Antlers\Patterns\TagParameter;
...
class AntlersLanguage extends HtmlLanguage
{
    ...
    public function getInjections(): array
    {
        return [
            ...
            new AntlersSubExpressionInjection(),
        ];
    }
